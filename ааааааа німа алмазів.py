...
class MainWindow(CTk):
    def __init__(self):
        ...
        # ========== ОСНОВНЕ ПОЛЕ ЧАТУ ==========
        self.chat_field = CTkTextbox(self,font=('Arial', 18, 'bold'), state='disable')  # Текстове поле лише для читання
        ...
        self.username = 'Logika'  # Ім'я за замовчуванням (можна змінити з меню)
    ...
    def toggle_show_menu(self):
        if self.is_show_menu:
            ...
            self.img_ctk = CTkImage(light_image = Image.open("images.png"),size =(50,50))
            self.label1 = CTkButton(self.menu_frame, text = 'Noo', image = self.img_ctk, command = self.rock)
    ...
    def rock(self):
        print('https://www.youtube.com/shorts/SXHMnicI6Pg' )
    ...
    def show_menu(self):
        ...
        # Закриття меню — доки ширина не менше 40
            ...
            self.after(10, self.show_menu)
            if self.label and self.entry and self.label_theme:
                self.label.destroy()
                self.entry.destroy()
